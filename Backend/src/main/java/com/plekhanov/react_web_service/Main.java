...
public class Main {
    ...
    //текущее: На фронте отображать товар, На фронте при выборе пола, перегружать данные

    //TODO:
    // Функциональные:
    // На фронте при выборе пола, перегружать данные
    ...
    // В типах продуктов сделать привязку к полу
