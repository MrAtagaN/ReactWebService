...
-- ProductType
INSERT INTO product_type (id, name, category)
values (1, 'jeans', 'clothes');


-- Product
INSERT INTO product (name, description, type_id, sub_type, brand, price, size, named_size, gender, age, color, is_new, is_sales)
values ('модель 123', 'джинсы классические, прямые', 1, null, 'gap', 4999, 32, null, 'male', 'adult', 'синие', true, false);
