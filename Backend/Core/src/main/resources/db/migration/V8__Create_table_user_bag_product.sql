...
(
    user_id       INTEGER CONSTRAINT user_bag_product_user_id_fk REFERENCES users (id) ON DELETE CASCADE,
    product_id    INTEGER CONSTRAINT user_bag_product_product_id_fk REFERENCES product (id) ON DELETE CASCADE,
    count         INTEGER,
